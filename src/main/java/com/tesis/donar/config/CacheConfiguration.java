package com.tesis.donar.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.tesis.donar.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.tesis.donar.repository.UserRepository.USERS_BY_EMAIL_CACHE);
