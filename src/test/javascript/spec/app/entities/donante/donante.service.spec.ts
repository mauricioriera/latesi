...
describe('Service Tests', () => {
  describe('Donante Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Donante', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            fechaNacimiento: currentDate.format(DATE_FORMAT)
      ...
      it('should update a Donante', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            apellido: 'BBBBBB',
      ...
      it('should return a list of Donante', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            apellido: 'BBBBBB',
      ...
      it('should delete a Donante', async () => {
